package net.mcreator.talir.world.features.treedecorators;
...
public class NicotaFruitDecorator extends CocoaDecorator {
	public static final NicotaFruitDecorator INSTANCE = new NicotaFruitDecorator();
	public static com.mojang.serialization.Codec<NicotaFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("nicota_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public NicotaFruitDecorator() {
		super(0.2f);
	}
